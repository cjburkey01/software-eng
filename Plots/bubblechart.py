...
# Preparing data
# > Creates a bubble chart with the x-axis as number of recovered cases, y-axis
#   as number of unrecovered cases, the bubbles labeled by the country name,
#   with sizes relative to the number of confirmed cases.
data = [
